...
namespace _01._StudentSystem.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CourseEnrollmentsCourseId = table.Column<int>(type: "int", nullable: false),
                    StudentsEnrolledStudentId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseStudent", x => new { x.CourseEnrollmentsCourseId, x.StudentsEnrolledStudentId });
                    table.ForeignKey(
                        name: "FK_CourseStudent_Courses_CourseEnrollmentsCourseId",
                        column: x => x.CourseEnrollmentsCourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
